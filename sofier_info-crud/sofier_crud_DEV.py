...
class SofierCRUD(object):
    ...
    def __init__(self):
        ...
        self.__collection = mongodb['sofie']['sofier_info']
        self.__mongodb = mongodb['sofie']
        print(mongodb['sofier']['sofier_info'])
    ...
    def get_info(self, sofier: str) -> dict:
        ...
        buffer = self.__collection.find_one({'sofier': sofier})
        print(sofier)
        print(buffer)
        _sofier = buffer
        print('GET ITEM')
    ...
    def tasks(self, sofier):
        ...
        execution_collection = self.__mongodb['table_micro_task_execution']
        cursor = execution_collection.find({'result': 'FINISH', 'who': sofier})
        items = list()
        for item in cursor:
            items.append(item)
        return len(items)
